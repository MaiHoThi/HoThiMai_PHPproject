...
<div class="container">
	<table class="table table-hover" border="1" cellspacing="0" cellpadding="10">
		<thead>
			<tr><th>ID</th><th>Ảnh</th><th>Name</th><th>Giá</th><th>Giảm giá</th><th>Số lượng</th><th>Tổng giá</th><th>Xóa</th></tr>
		</thead>
		<tbody>
			...
			if(isset($_SESSION["cart"])==true) {
				...
				$results="SELECT id_order, p.image, p.namepro,p.price,p.sale,c.quantity From products as p, cart as c where p.id_pro = c.id_pro;";
				...
				while( $row=mysqli_fetch_array($sql)){
 				...
 				# code...
					...
					<td>".$row['sale']."</td>
					<td><input type='number' min='1'value='".$row['quantity']."'></input></td>";
